...
cat $dir/logping.txt | grep -c CEST > $dir/numeroCEST.txt 
cat $dir/logping.txt | grep -c rtt > $dir/numeroRtt.txt

echo "Tentativi (CEST): " >> $dir/logping.txt ; cat $dir/numeroCEST.txt >> $dir/logping.txt
echo "Riusciti (rtt): " >> $dir/logping.txt ; cat $dir/numeroRtt.txt >> $dir/logping.txt
